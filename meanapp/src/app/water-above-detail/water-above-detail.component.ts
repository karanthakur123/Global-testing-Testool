...
@Component({
  selector: 'app-water-above-detail',
  templateUrl: './water-above-detail.component.html',
  styleUrls: ['./water-above-detail.component.css'],
  providers:[AuthService,{provide:LocationStrategy,useClass:HashLocationStrategy}]

})
export class WaterAboveDetailComponent implements OnInit {
  ...
  onInsert() {
    console.log("coming...")
    this.authService.onInsert__above_details({
