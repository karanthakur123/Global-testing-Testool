...
var t=[];
@Component({
  selector: 'app-update-above-noise-detail',
  templateUrl: './update-above-noise-detail.component.html',
  styleUrls: ['./update-above-noise-detail.component.css'],
  providers:[AuthService,{provide:LocationStrategy,useClass:HashLocationStrategy}]

})
export class UpdateAboveNoiseDetailComponent implements OnInit {
  ...
  onupdate() {
    ...
    this.authService.onupdate_noise_above_details({
