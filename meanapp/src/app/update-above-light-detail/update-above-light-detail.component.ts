...
var t=[];
@Component({
  selector: 'app-update-above-light-detail',
  templateUrl: './update-above-light-detail.component.html',
  styleUrls: ['./update-above-light-detail.component.css'],
  providers:[AuthService,{provide:LocationStrategy,useClass:HashLocationStrategy}]

})
export class UpdateAboveLightDetailComponent implements OnInit {
  location1:string;
  com:string;
  testForm: FormGroup;
  data:object
  ...
  onupdate() {
    ...
    this.authService.onupdate_light_above_details({
